...
docker run -d vemonet/data2services-sparql-operations -f "https://github.com/MaastrichtU-IDS/d2s-transform-repository/tree/master/sparql/insert-biolink/huri" -ep "https://graphdb.dumontierlab.com/repositories/test/statements" -un emonet -pw $PASSWORD --var-service-url http://localhost:7200/repositories/ncats-test --var-input-graph https://w3id.org/data2services/graph/autor2rml/huri --var-output-graph https://w3id.org/data2services/graph/biolink/huri
...
docker run -d --name convert_huri data2services-sparql-operations -f "https://github.com/MaastrichtU-IDS/d2s-transform-repository/tree/master/sparql/insert-biolink/huri" -ep "https://graphdb.dumontierlab.com/repositories/ncats-red-kg/statements" -un emonet -pw $PASSWORD -var serviceUrl:http://localhost:7200/repositories/ncats-test inputGraph:https://w3id.org/data2services/graph/autor2rml/huri outputGraph:https://w3id.org/data2services/graph/biolink/huri
