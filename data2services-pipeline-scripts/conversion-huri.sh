...
docker run -d vemonet/data2services-sparql-operations -f "https://github.com/MaastrichtU-IDS/data2services-transform-repository/tree/master/sparql/insert-biolink/huri" -ep "http://graphdb.dumontierlab.com/repositories/test/statements" -un emonet -pw $PASSWORD --var-service-url http://localhost:7200/repositories/ncats-test --var-input-graph https://w3id.org/data2services/graph/autor2rml/huri --var-output-graph https://w3id.org/data2services/graph/biolink/huri
