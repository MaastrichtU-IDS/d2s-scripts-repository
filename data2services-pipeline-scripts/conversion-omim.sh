...
docker run -d --name convert_omim data2services-sparql-operations -f "https://github.com/MaastrichtU-IDS/d2s-transform-repository/tree/master/sparql/insert-biolink/omim" -ep "http://graphdb.dumontierlab.com/repositories/ncats-red-kg/statements" -un emonet -pw $PASSWORD -var serviceUrl:http://localhost:7200/repositories/ncats-test inputGraph:https://w3id.org/data2services/graph/autor2rml/omim outputGraph:https://w3id.org/data2services/graph/biolink/omim
